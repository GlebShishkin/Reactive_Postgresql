...
// заполнение таблиц users и department созданных "schema.sql"
...
public class UserInitializer implements CommandLineRunner {
    ...
    private void initialDataSetup() {
        userRepository.deleteAll()
                .thenMany(Flux.fromIterable(getData())) // thenMany - ждет завершения исходного кода, затем воспроизводит все сигналы из его параметра Publisher<R>, что приведет к Flux<R>
